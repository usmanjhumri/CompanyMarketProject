...
export const signupSchema = Yup.object({
    firstname:Yup.string().min(2).max(20).required("Please enter your first name").matches(/^[a-zA-Z]+$/, 'Only alphabetic characters allowed'),
    lastname:Yup.string().min(2).max(20).required("Please enter your last name").matches(/^[a-zA-Z]+$/, 'Only alphabetic characters allowed'),
